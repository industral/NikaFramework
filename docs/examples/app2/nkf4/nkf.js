...
var
	...
	core_version = "1.9.2-pre -ajax/script,-ajax/jsonp,-effects,-deprecated",
...
(function() {
  ...
  ContextAbstract.className = "ContextAbstract";
  ...
  function ContextAbstract() {
    ...
    this.className = ContextAbstract.className;
  ...
  $.extend(self, {
    ContextAbstract: ContextAbstract
  });
